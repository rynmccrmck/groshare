@REM groceries launcher script
@REM
@REM Environment:
@REM JAVA_HOME - location of a JDK home dir (optional if java on path)
@REM CFG_OPTS  - JVM options (optional)
@REM Configuration:
@REM GROCERIES_config.txt found in the GROCERIES_HOME.
@setlocal enabledelayedexpansion

@echo off

if "%GROCERIES_HOME%"=="" set "GROCERIES_HOME=%~dp0\\.."

set "APP_LIB_DIR=%GROCERIES_HOME%\lib\"
...
set "CFG_FILE=%GROCERIES_HOME%\GROCERIES_config.txt"
set CFG_OPTS=
if exist %CFG_FILE% (
...
if "%JAVAOK%"=="false" (
  ...
  echo and download a valid Java JDK and install before running groceries.
  echo.
...
"%_JAVACMD%" !_JAVA_OPTS! !GROCERIES_OPTS! -cp "%APP_CLASSPATH%" %MAIN_CLASS% !_APP_ARGS!
